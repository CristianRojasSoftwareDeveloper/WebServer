...
namespace SharedKernel.Application.Operators.Generic.Operations.CRUD.Commands.DeleteEntityByID {
    ...
    public class DeleteEntityByID_CommandHandler<EntityType> : IOperationHandler<IDeleteEntityByID_Command, bool> where EntityType : IGenericEntity {
        ...
        public Task<bool> Handle (IDeleteEntityByID_Command command) =>
            _genericRepository.DeleteEntityByID(command.ID);
