...
namespace SharedKernel.Application.Models.Abstractions.Operations.Requests {
    ...
    public class TokenClaims {
        ...
        public TokenClaims (int userID, string username, string email, IEnumerable<string> roles, IEnumerable<Permissions> permissions) {
            UserID = userID;
            Username = username;
            Email = email;
            Roles = roles;
