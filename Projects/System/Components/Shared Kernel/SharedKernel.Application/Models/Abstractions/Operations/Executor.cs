...
namespace SharedKernel.Application.Models.Abstractions.Operations {
    ...
    public static class Executor {
        ...
        /// <param name="operation">Función que representa la operación a ejecutar (sincrónica o asincrónica). Si la operación es sincrónica, se debe envolver en un Task utilizando Task.FromResult.</param>
