...
namespace Users.Application.Operators.Permissions.Operations.CRUD.Commands.AddPermission {
    ...
    /// </summary>
    public class AddPermission_CommandHandler : IOperationHandler<IAddPermission_Command, Permission> {
        ...
        public async Task<Permission> Handle (IAddPermission_Command command) {
            ...
            else if (await _permissionRepository.FirstOrDefault(permission => permission.Name!.Equals(command.Entity.Name)) != null)
            ...
            return await _permissionRepository.AddPermission(command.Entity);
        }
