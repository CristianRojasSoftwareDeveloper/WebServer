...
namespace SystemLogs.Application.Operators.SystemLogs.Operations.CRUD.Commands.UpdateSystemLog {
    ...
    /// </summary>
    public class UpdateSystemLog_CommandHandler : IOperationHandler<IUpdateSystemLog_Command, SystemLog> {
        ...
        public Task<SystemLog> Handle (IUpdateSystemLog_Command command) {
            ...
            return _systemLogRepository.UpdateSystemLog(systemLogUpdate);
