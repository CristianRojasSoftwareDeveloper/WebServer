...
namespace SharedKernel.Infrastructure.Services.Persistence.Entity_Framework {
    ...
    public abstract class GenericRepository_EntityFramework<EntityType> : IGenericRepository<EntityType> where EntityType : class, IGenericEntity {
        ...
        protected GenericRepository_EntityFramework (DbContext dbContext) {
